...
import { DropdownProps, SearchResult } from "@/types/search";
  ...
  const content = useMemo(() => {
    ...
    if (items.length === 0 && query.length > 0) {
      return renderEmpty ? (
        ...
        <div className="px-4 py-6 text-center text-si-placeholder text-sm">
          No results for{" "}
          <span className="text-si-text font-medium">"{query}"</span>
        </div>
      );
    }
