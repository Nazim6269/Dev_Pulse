...
import type { StreakStatModel } from "@/features/profile/types/profile.types";
...
export function StreakStats({ items }: { items: StreakStatModel[] }) {
  ...
  return <div className="mt-4 flex items-center gap-4 border-t border-white/[0.05] pt-4">{streakItems}</div>;
}
