...
import { useCommitDistribution } from "@/entities/commit/model/useCommitDistribution";
import { useDailyCommitVolume } from "@/entities/commit/model/useDailyCommitVolume";
import type {
  BadgeVariant,
...
export function useCommitCharts() {
  ...
  const peakActivity = useMemo(() => {
    const ranked = [...timeOfDayRows].sort(
