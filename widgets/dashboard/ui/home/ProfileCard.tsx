    ...
    <div className="h-full bg-card border border-border rounded-2xl p-5 flex flex-col gap-4 shadow-sm">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[15px] font-semibold text-foreground leading-tight truncate">Nazim Uddin</p>
          <p className="text-[12px] text-muted-foreground mt-0.5">@nazimdev10022001@gmail.com</p>
      ...
      {/* Link */}
      <div className="flex items-center gap-1.5 text-[12px] text-violet-500 font-medium">
        <Link2 size={11} />
      ...
      {/* Top languages */}
      <div>
        <p className="text-[10px] text-muted-foreground/40 uppercase tracking-widest mb-2">Top languages</p>
        <div className="flex flex-wrap gap-1.5">
          {Object.entries(langColors).map(([lang, dot]) => (
            <div key={lang} className="flex items-center gap-1.5 bg-muted/30 border border-border rounded-lg px-2.5 py-1">
